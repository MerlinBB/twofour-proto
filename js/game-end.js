...
       
    ...
    var paused = false;
    var currentPrize = 0;
    var cashPrizes = ["£100", "£200", "£400", "£800", "£1200", "£2400", "£5000", "£10,000", "£20,000", "£50,000"];
    ...
    var tetris = {
        ...
        getQuestions: function () {
            ...
            questions = _.where(Questions, { num: 1 });
        ...
        setRowsToWin: function (e) {
            rowsToWin = parseInt($(".rows").val(), 16);
        },
